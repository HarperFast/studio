...
export function CreateTableGUI() {
	...
	return (
		<div className="p-2 md:p-16">
			<h2 className="text-2xl"> Create Table</h2>
			<Accordion type="single" collapsible className="mb-4 border-b">
				<AccordionItem value="create-table-info">
					<AccordionTrigger>Why create a table?</AccordionTrigger>
					<AccordionContent>
						Creating a table is the basis of a data-driven application and can immediately be used as RESTful endpoint.
