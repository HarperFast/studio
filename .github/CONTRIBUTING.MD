...
- Start the dev server (Fabric mode): `pnpm dev` (alias of `pnpm dev:fabric`)
...
- Build: `pnpm build` (deploy environments: `pnpm build --mode dev|stage|prod`; Local Studio: `pnpm build:local`)
